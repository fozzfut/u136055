...
<?$APPLICATION->IncludeComponent( "bitrix:main.include", "", Array(     "COMPONENT_TEMPLATE" => ".default",     "AREA_FILE_SHOW" => "file",     "AREA_FILE_SUFFIX" => "inc",     "EDIT_TEMPLATE" => "",     "PATH" => "include_areas/email.php"     ));?>
<?$APPLICATION->IncludeComponent( "bitrix:main.include", "", Array(     "COMPONENT_TEMPLATE" => ".default",     "AREA_FILE_SHOW" => "file",     "AREA_FILE_SUFFIX" => "inc",     "EDIT_TEMPLATE" => "",     "PATH" => "include_areas/phone.php"     ));?>
</div>
</div>
<!-- end main content -->
...
<div class="small-footer">
    <div class="containit">
        ...
        <div class="copy">Copyright <?echo( date("Y"));?> </div>
        <div class="social">
